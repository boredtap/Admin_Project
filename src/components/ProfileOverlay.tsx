...
const ProfileOverlay: React.FC<ProfileOverlayProps> = ({ onClose, user }) => {
    ...
    <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50" onClick={onClose}>
      ...
      >
        ...
        <div className="relative text-center py-5">
          ...
          <button className="absolute right-0 top-1/2 -translate-y-1/2" onClick={onClose}>
            <Image
              ...
              width={24}
              height={24}
              onError={() => console.error("Failed to load cancel.png")}
            />
          </button>
        </div>
            ...
            {displayData.wallet_address ? (
              ...
              <>
                <Image
                  ...
                  width={50}
                  height={50}
                  onError={() => console.error("Failed to load wallet.png")}
                />
                <span>-</span>
              </>
            )}
        ...
        <div className="flex justify-center gap-4 mt-6">
            ...
            <>
              ...
              >
                <Image
                  ...
                  width={20}
                  height={20}
                  onError={() => console.error("Failed to load suspend.png")}
                />
                Suspend
              </button>
              <button
              ...
              >
                <Image
                  ...
                  width={20}
                  height={20}
                  onError={() => console.error("Failed to load ban.png")}
                />
                Ban
              </button>
            </>
          ...
          {isSuspended && (
            <button
              className="flex items-center gap-2 bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 text-xs"
              onClick={(e) => {
                e.stopPropagation();
            ...
            >
              <Image
                ...
                width={20}
                height={20}
                onError={() => console.error("Failed to load resume.png")}
              />
              Resume
            </button>
          )}
      ...
      {showActionOverlay && (
        ...
        >
          <div
            className="bg-[#202022] rounded-lg p-6 text-white w-[320px] text-center relative"
            onClick={(e) => e.stopPropagation()}
          >
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              <Image
                ...
                width={30}
                height={30}
                onError={() => console.error(`Failed to load ${showActionOverlay}.png`)}
              />
              <h2 className="text-xl font-bold">
                {`${showActionOverlay.charAt(0).toUpperCase() + showActionOverlay.slice(1)}?`}
              </h2>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Image
                      ...
                      onError={() => console.error("Failed to load date.png")}
      ...
      {showSuccessOverlay && (
        ...
        >
          <div
            className="bg-[#202022] rounded-lg p-6 text-white w-[320px] text-center"
            onClick={(e) => e.stopPropagation()}
          >
            <Image
              src="/success.png"
              ...
              onError={() => console.error("Failed to load success.png")}
            />
        ...
        >
          ...
          >
            <Image
              ...
              height={100}
              className="mb-4 mx-auto"
              onError={() => console.error("Failed to load error.png")}
            />
